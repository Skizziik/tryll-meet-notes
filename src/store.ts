...
export interface MeetingRecord {
  ...
  emailedAt?: string;
  /** бот хоть раз реально появился в running (был в мите) — справочно */
  botSeenRunning?: boolean;
  /** бот хоть раз дал аудио-чанк (реально писал, даже тишину). Надёжно отличает
   *  «упал на старте» (аудио НЕ было) от «зашёл, но никто не говорил» (аудио было).
   *  Vexa на миг метит упавший контейнер running, поэтому seenRunning ненадёжен. */
